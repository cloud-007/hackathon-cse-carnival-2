...
mixin _$ChatResponse {
  ...
  List<ChatItemResponse> get results => throw _privateConstructorUsedError;
...
abstract class $ChatResponseCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'results') List<ChatItemResponse> results});
}
...
class _$ChatResponseImpl implements _ChatResponse {
  const _$ChatResponseImpl(
      ...
      @JsonKey(name: 'results') required final List<ChatItemResponse> results})
      : _results = results;
  ...
  final List<ChatItemResponse> _results;
  @override
  @JsonKey(name: 'results')
  List<ChatItemResponse> get results {
  ...
  @override
  String toString() {
    return 'ChatResponse(count: $count, next: $next, previous: $previous, results: $results)';
  }
...
abstract class _ChatResponse implements ChatResponse {
  const factory _ChatResponse(
      ...
      @JsonKey(name: 'results')
      required final List<ChatItemResponse> results}) = _$ChatResponseImpl;
